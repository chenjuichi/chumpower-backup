...
// 封裝各 API
const dialog2StartProcess = p_apiOperation('post', '/dialog2StartProcessMP');
const dialog2UpdateProcess = p_apiOperation('post', '/dialog2UpdateProcessMP');
const dialog2ToggleProcess = p_apiOperation('post', '/dialog2ToggleProcessMP');
const dialog2CloseProcess = p_apiOperation('post', '/dialog2CloseProcessMP');
