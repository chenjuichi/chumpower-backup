...
// ★ 真正的併單決策
//
// 不再讓 updateItem() 直接相信 group1。
// group1 只負責畫面 radio。
// ============================================================

const selectedMergeEnabled = ref(true);
const mergeChoiceTouched = ref(false);
...
isInitializingMergeRadio.value =
  false;
  //
...
const updateItem = async () => {
  ...
  console.log(
    "MaterialListForAssm.vue, updateItem(),",
    boms.value
  );
