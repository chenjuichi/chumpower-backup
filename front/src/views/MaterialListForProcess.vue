      ...
      <v-card>
        ...
        >
          ...
          <div
            ...
            v-show="!c_isBlinking && materials.length > 0">
            <v-text-field
...
const toggle_exclusive = ref(1);              // 控制選擇的按鈕, 預設AGV:2, 人推車:1
...
const checkReceiveQty = (item) => {
  ...
  //if (deliveryQty != totalQty && deliveryQty != 0) {
  //  let temp_str = item.order_num + '領料數量不能改變！'
