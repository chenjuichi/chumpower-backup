    ...
    >
      ...
      <template v-slot:item.order_num="{ item }">
        <div style="display: flex; align-items: center;">
          ...
          <div style="color: blue; margin-right: 20px;" v-if="item.isAssembleStationShow && item.isLackMaterial == 99">
