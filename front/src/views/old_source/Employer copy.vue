                  ...
                  <v-card-text>
                    <v-container>
                          ...
                          <div class="d-flex align-center flex-column pa-6" style="padding-top: 0px !important;">
                            ...
                            >
                              <v-btn style="height: auto; padding: 0; font-size: 8px;">
                                <span class="fa-stack fa-2x"> <!--icon 疊加-->
                                  ...
                                  <!--<i class="fa-solid fa-align-right fa-stack-1x" style="position: absolute; right: 0; opacity:0.3"></i>-->
                                </span>
                              </v-btn>
                              <v-btn style="height: auto; padding: 0; font-size: 8px;" variant="tonal">
                                <span class="fa-stack fa-2x">
                                  <!--<i class="fa-solid fa-people-group fa-stack-2x" style="color: #1565C0; font-size: 1.6em; position: absolute; transform: translate(-10%, 30%);"></i>-->
                                  <i class="fa-solid fa-user-lock fa-stack-2x" style="color: #1565C0; font-size: 1.4em; position: absolute; transform: translate(-10%, 30%);"></i>
                      ...
                      <v-row v-if="editedIndex != -1">
                        ...
                        <v-col cols="12" md="9">
                          <v-list-subheader style="margin-bottom: 0; height: 18px; font-size: 18px;">
