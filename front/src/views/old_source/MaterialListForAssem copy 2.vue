<template>
      ...
      <v-card flat class="card-container">
        <v-card-title class="d-flex align-center pe-2 sticky-card-title">
          ...
          <v-divider class="mx-4" inset vertical></v-divider>
              <v-spacer></v-spacer>
              <v-btn color="primary" variant="outlined" style="position: relative; left: -100px; top: 0px;" @click="addItem">
                <v-icon left color="green">mdi-microsoft-excel</v-icon>匯入清單
              </v-btn>

              <v-btn color="primary" variant="outlined" style="position: relative; left: -80px; top: 0px;" @click="addItem">
        ...
        >
          <template #top>
            <v-dialog v-model="dialog" max-width="700" content-class="custom-card-radius">
              <v-card>
                <v-card-title class="sticky-title"><span class="text-h5">備料資訊</span></v-card-title>
                <v-card-text>
                  <div>
                    <v-data-table :items="virtualBoats" :headers="headers_detail" fixed-header density="compact" items-per-page="5">
                      <template v-slot:item.material_num="{ item }">
                        <div>
                          <!-- 顯示前12個字符 -->
                          <div>{{ item.material_num.substring(0, 12) }}</div>
                          <!-- 顯示剩下的部分並設置紅色 -->
                          <div style="color: red; font-weight:600">{{ item.material_num.substring(12) }}</div>
                        </div>
                      </template>
                      ...
                      <template v-slot:item.lack="{ item }">
                        <v-checkbox-btn
                          v-model="item.lack"
                        ></v-checkbox-btn>
                      </template>
  ...
  const roles = [
    { order_num: 'A23456789012', material_num: '1234567890123456', req_qty: 100, location: 'M5-3', shortage_note: '元件缺料',comment: '1備料清單說明測試字串2備料清單說明測試字串25字'},
    { order_num: 'B23456789012', material_num: '1234567890123456', req_qty: 100, location: 'M5-3', shortage_note: '元件缺料',comment: '1備料清單說明測試字串2備料清單說明測試字串25字'},
    { order_num: 'C23456789012', material_num: '1234567890123456', req_qty: 100, location: 'M5-3', shortage_note: '元件缺料',comment: '1備料清單說明測試字串2備料清單說明測試字串25字'},
    { order_num: 'D23456789012', material_num: '1234567890123456', req_qty: 100, location: 'M5-3', shortage_note: '元件缺料',comment: '1備料清單說明測試字串2備料清單說明測試字串25字'},
    { order_num: 'E23456789012', material_num: '1234567890123456', req_qty: 100, location: 'M5-3', shortage_note: '元件缺料',comment: '1備料清單說明測試字串2備料清單說明測試字串25字'},
    { order_num: 'F23456789012', material_num: '1234567890123456', req_qty: 100, location: 'M5-3', shortage_note: '元件缺料',comment: '1備料清單說明測試字串2備料清單說明測試字串25字'},
    { order_num: 'G23456789012', material_num: '1234567890123456', req_qty: 100, location: 'M5-3', shortage_note: '元件缺料',comment: '1備料清單說明測試字串2備料清單說明測試字串25字'},
    { order_num: 'H23456789012', material_num: '1234567890123456', req_qty: 100, location: 'M5-3', shortage_note: '元件缺料',comment: '1備料清單說明測試字串2備料清單說明測試字串25字'},
    { order_num: 'I23456789012', material_num: '1234567890123456', req_qty: 100, location: 'M5-3', shortage_note: '元件缺料',comment: '1備料清單說明測試字串2備料清單說明測試字串25字'},
    { order_num: 'J23456789012', material_num: '1234567890123456', req_qty: 100, location: 'M5-3', shortage_note: '元件缺料',comment: '1備料清單說明測試字串2備料清單說明測試字串25字'},
  ];

  const virtualBoats = [
  { element_num: '0010', material_num: 'A23456789012KL16S本體', qty: 100, date: '2024/10/30', receive: false, lack: false },
  { element_num: '0020', material_num: 'A23456789012KL16S三爪', qty: 100, date: '2024/10/30', receive: false, lack: false },
  { element_num: '0030', material_num: 'A23456789012HELLO', qty: 100, date: '2024/10/30', receive: false, lack: false },
  { element_num: '0040', material_num: 'A23456789012HELLO', qty: 100, date: '2024/10/30', receive: false, lack: false },
  { element_num: '0050', material_num: 'A23456789012HELLO', qty: 100, date: '2024/10/30', receive: false, lack: false },
  { element_num: '0060', material_num: 'A23456789012HELLO', qty: 100, date: '2024/10/30', receive: false, lack: false },
  { element_num: '0070', material_num: 'A23456789012HELLO', qty: 100, date: '2024/10/30', receive: false, lack: false },
  { element_num: '0080', material_num: 'A23456789012HELLO', qty: 100, date: '2024/10/30', receive: false, lack: false },
  { element_num: '0090', material_num: 'A23456789012HELLO', qty: 100, date: '2024/10/30', receive: false, lack: false },
  { element_num: '0100', material_num: 'A23456789012HELLO', qty: 100, date: '2024/10/30', receive: false, lack: false },
  ...
  position: sticky;
  top: 0;
  background-color: white; /* 保持背景色與卡片一致 */
  z-index: 1; /* 確保它在其他內容之上 */
  padding-top: 10px; /* 調整間距以更好地符合設計 */
  padding-bottom: 10px;
}
  </style>
