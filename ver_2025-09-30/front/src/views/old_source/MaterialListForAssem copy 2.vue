          ...
          <div class="button-container">
            <v-btn-toggle v-model="toggle_exclusive" class="group">
              <v-btn
                variant="outlined"
                :style="{
                  backgroundColor: toggle_exclusive === 1 ? '#e67e22' : '#fff',
              ...
              <v-btn
                variant="outlined"
                :style="{
                  backgroundColor: toggle_exclusive === 2 ? '#27ae60' : '#fff',
              ...
              <div
                class="bg"
                :style="{
                  transform: `translateX(${(toggle_exclusive - 1) * 100}%)`,
                  width: '50%'
                }"
              />
            </v-btn-toggle>
