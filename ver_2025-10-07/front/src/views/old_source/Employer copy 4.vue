      ...
      >
        <template #top>
          <v-toolbar flat>
            ...
            <v-dialog v-model="dialog" persistent max-width="760" max-height="auto">
            <!--
              <v-card>
                <v-card-title>
            ...
            -->
              ...
              <v-card style="width: 100%; height: auto;">
                ...
                <v-card-text style="top: -15px; position: relative;">
                  <div class="card_container creditcard">
                      ...
                      <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        <g id="CardBackground">
                          ...
                          <foreignObject x="40" y="240" width="670" height="200">
                ...
                <v-card-actions style="top: -35px; position: relative;">
                  <v-spacer></v-spacer>
                  <v-btn color="primary" @click="dialog = false">關閉</v-btn>

                <v-spacer></v-spacer>
                  <v-btn
                    :icon="showExplore ? 'mdi-chevron-up' : 'mdi-chevron-down'"
                    @click="showExplore = !showExplore"
                  ></v-btn>
                </v-card-actions>
                <v-expand-transition>
                  <div v-show="showExplore">
                    <v-divider></v-divider>
                    <v-card-text>
                    </v-card-text>
                  </div>
